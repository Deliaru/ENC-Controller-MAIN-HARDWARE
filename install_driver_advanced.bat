@echo off
chcp 65001 >nul
title E.N.C Controller 智能驱动安装工具
...
echo.
echo ========================================
echo    E.N.C Controller 智能驱动安装工具
echo ========================================
echo.
...
if %errorLevel% neq 0 (
    ...
    if %errorLevel% neq 0 (
        echo 警告：此驱动主要支持 Windows 10/11 和 Windows 8.1
        echo    当前系统可能不完全兼容
        echo.
        echo 是否继续安装？(Y/N)
        set /p choice=
